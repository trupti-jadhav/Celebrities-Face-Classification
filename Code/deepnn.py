...
#HIDDEN LAYER 3
def create_multilayer_perceptron_3():
    # Network Parameters
    n_hidden_1 = 256  # 1st layer number of features
...
#HIDDEN LAYER 5
def create_multilayer_perceptron_5():
    # Network Parameters
    n_hidden_1 = 256  # 1st layer number of features
    n_hidden_2 = 128  # 2nd layer number of features
    n_hidden_3 = 128  # 3rd layer number of features
    n_hidden_4 = 128  # 3rd layer number of features
...
#HIDDEN LAYER 7
def create_multilayer_perceptron_7():
    # Network Parameters
    n_hidden_1 = 256  # 1st layer number of features
    n_hidden_2 = 128  # 2nd layer number of features
    n_hidden_3 = 128  # 3rd layer number of features
    n_hidden_4 = 128  # 3rd layer number of features
    n_hidden_5 = 128  # 5th layer number of features
    n_hidden_6 = 64  # 3rd layer number of features
    n_hidden_7 = 64  # 7th layer number of features
    n_input = 2376  # data input
    n_classes = 2
...
s = time.time()
pred,x,y = create_multilayer_perceptron_3()
Calculate(pred,x,y)
e = time.time()
print("Time: ", e-s)

s = time.time()
pred,x,y = create_multilayer_perceptron_5()
Calculate(pred,x,y)
e = time.time()
print("Time: ", e-s)

s = time.time()
pred,x,y = create_multilayer_perceptron_7()
Calculate(pred,x,y)
e = time.time()
print("Time: ", e-s)
